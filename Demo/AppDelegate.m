...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSNumber *firstTime = [[NSUserDefaults standardUserDefaults] objectForKey:@"FirstTime"];
    
    if(firstTime!=nil){
        self.window.rootViewController = [UIStoryboard instantiateRootViewController];
    }
    
    [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:NO] forKey:@"FirstTime"];
    [[NSUserDefaults standardUserDefaults] synchronize];
    [AppGlobalStyle applyGlobalStyle];
